...
from ideal_robot import*    #３章のクラス群を使えるようにする
from scipy.stats import expon, norm, uniform    #exponは指数分布の機能を提供するオブジェクト  uniformは一様分布を扱うオブジェクト


# In[2]:


class Robot(IdealRobot):    #IdealRobotクラスの機能を引き継いだRobotクラス
